...
private:
	 ...
	 */
	mach_vm_address_t orgPopulateAccelConfig[1]{};

	/**
	 *  Original getHWInfo functions
	 */
	mach_vm_address_t orgGetHWInfo[1]{};
	 ...
	 */
	t_populateAccelConfig wrapPopulateAccelConfig[1]{
		populdateAccelConfig<0>};
