...
IOReturn RAD::wrapPopulateDeviceInfo(uint64_t that) {
    NETLOG("rad",
           "AMDRadeonX5000_AmdAsicInfoNavi::populateDeviceInfo: this = 0x%llX",
           that);
...
bool RAD::processKext(KernelPatcher &patcher, size_t index,
    ...
    if (kextRadeonFramebuffer.loadIndex == index) {
         ...
         */
        KernelPatcher::LookupPatch patch = {&kextRadeonX5000HWLibs,
         ...
         * Uses Vega 20 branch.
         */
        uint8_t find[] = {0x0f, 0x8c, 0x32, 0x00, 0x00, 0x00, 0x0f,
                          0xb7, 0x45, 0xe6, 0x3d, 0xbf, 0x66, 0x00,
                          0x00, 0x0f, 0x8f, 0x23, 0x00, 0x00, 0x00};
        uint8_t repl[] = {0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x0f,
                          0xb7, 0x45, 0xe6, 0x3d, 0xbf, 0x66, 0x00,
        ...
        uint8_t find_hwchannel_init1[] = {0x74, 0x54, 0x49, 0x8b, 0x7c, 0x24,
                                          0x18, 0x48, 0x8b, 0x07, 0xff, 0x90,
                                          0xb8, 0x03, 0x00, 0x00};
        uint8_t repl_hwchannel_init1[] = {0x74, 0x54, 0x49, 0x8b, 0x7c, 0x24,
                                          0x18, 0x48, 0x8b, 0x07, 0xff, 0x90,
                                          0xc0, 0x03, 0x00, 0x00};
        uint8_t find_hwchannel_init2[] = {
            };
        uint8_t repl_hwchannel_init2[] = {
            };

        uint8_t find_hwchannel_submitCommandBuffer[] = {
            0x48, 0x8b, 0x7b, 0x18, 0x48, 0x8b, 0x07, 0xff, 0x90,
            0x30, 0x02, 0x00, 0x00, 0x48, 0x8b, 0x43, 0x50};
        uint8_t repl_hwchannel_submitCommandBuffer[] = {
            0x48, 0x8b, 0x7b, 0x18, 0x48, 0x8b, 0x07, 0x90, 0x90,
            0x90, 0x90, 0x90, 0x90, 0x48, 0x8b, 0x43, 0x50};

        uint8_t find_hwchannel_waitForHwStamp[] = {
            0x49, 0x8b, 0x7d, 0x18, 0x48, 0x8b, 0x07, 0xff, 0x90, 0xa0,
            0x02, 0x00, 0x00, 0x84, 0xc0, 0x74, 0x2e, 0x44, 0x39, 0xfb};
        uint8_t repl_hwchannel_waitForHwStamp[] = {
            0x49, 0x8b, 0x7d, 0x18, 0x48, 0x8b, 0x07, 0xff, 0x90, 0x98,
            0x02, 0x00, 0x00, 0x84, 0xc0, 0x74, 0x2e, 0x44, 0x39, 0xfb};

        uint8_t find_hwchannel_reset[] = {
            0x48, 0x8b, 0x7b, 0x18, 0x48, 0x8b, 0x07, 0xff, 0x90, 0xb8,
            0x03, 0x00, 0x00, 0x49, 0x89, 0xc6, 0x48, 0x8b, 0x03};
        uint8_t repl_hwchannel_reset[] = {
            0x48, 0x8b, 0x7b, 0x18, 0x48, 0x8b, 0x07, 0xff, 0x90, 0xc0,
            0x03, 0x00, 0x00, 0x49, 0x89, 0xc6, 0x48, 0x8b, 0x03};

        uint8_t find_hwchannel_timestampUpdated1[] = {
            0x74, 0x20, 0x48, 0x8b, 0x7b, 0x18, 0x48, 0x8b, 0x07, 0xff, 0x90,
            0xb8, 0x03, 0x00, 0x00, 0x48, 0x8b, 0xb3, 0xc8, 0x00, 0x00, 0x00};
        uint8_t repl_hwchannel_timestampUpdated1[] = {
            0x74, 0x20, 0x48, 0x8b, 0x7b, 0x18, 0x48, 0x8b, 0x07, 0xff, 0x90,
            0xc0, 0x03, 0x00, 0x00, 0x48, 0x8b, 0xb3, 0xc8, 0x00, 0x00, 0x00};
        uint8_t find_hwchannel_timestampUpdated2[] = {
            0x48, 0x8b, 0x7b, 0x18, 0x48, 0x8b, 0x07, 0xff,
            0x90, 0xb8, 0x03, 0x00, 0x00, 0x49, 0x8b, 0xb6,
            0x50, 0x03, 0x00, 0x00, 0x48, 0x89, 0xc7};
        uint8_t repl_hwchannel_timestampUpdated2[] = {
            0x48, 0x8b, 0x7b, 0x18, 0x48, 0x8b, 0x07, 0xff,
            0x90, 0xc0, 0x03, 0x00, 0x00, 0x49, 0x8b, 0xb6,
            0x50, 0x03, 0x00, 0x00, 0x48, 0x89, 0xc7};

        uint8_t find_hwchannel_enableTimestampInterrupt[] = {
            0x85, 0xc0, 0x74, 0x14, 0x48, 0x8b, 0x7b, 0x18,
            0x48, 0x8b, 0x07, 0xff, 0x90, 0xa0, 0x02, 0x00,
            0x00, 0x41, 0x89, 0xc6, 0x41, 0x80, 0xf6, 0x01};
        uint8_t repl_hwchannel_enableTimestampInterrupt[] = {
            0x85, 0xc0, 0x74, 0x14, 0x48, 0x8b, 0x7b, 0x18,
            0x48, 0x8b, 0x07, 0xff, 0x90, 0x98, 0x02, 0x00,
            0x00, 0x41, 0x89, 0xc6, 0x41, 0x80, 0xf6, 0x01};

        uint8_t find_hwchannel_writeDiagnosisReport[] = {
            0x49, 0x8b, 0x7c, 0x24, 0x18, 0x48, 0x8b, 0x07, 0xff,
            0x90, 0xb8, 0x03, 0x00, 0x00, 0x49, 0x8b, 0xb4, 0x24,
            0xc8, 0x00, 0x00, 0x00, 0xb9, 0x01, 0x00, 0x00, 0x00};
        uint8_t repl_hwchannel_writeDiagnosisReport[] = {
            0x49, 0x8b, 0x7c, 0x24, 0x18, 0x48, 0x8b, 0x07, 0xff,
            0x90, 0xc0, 0x03, 0x00, 0x00, 0x49, 0x8b, 0xb4, 0x24,
            0xc8, 0x00, 0x00, 0x00, 0xb9, 0x01, 0x00, 0x00, 0x00};
        ...
        KernelPatcher::LookupPatch patches[] = {
             ...
             */
            {&kextRadeonX6000, find_hwchannel_init1, repl_hwchannel_init1,
             arrsize(find_hwchannel_init1), 2},
            /**
             * Mismatched VTable Calls to getGpuDebugPolicy.
             */
            {&kextRadeonX6000, find_hwchannel_init2, repl_hwchannel_init2,
             arrsize(find_hwchannel_init2), 2},
            /**
             * VTable Call to signalGPUWorkSubmitted.
             * Doesn't exist on X5000, but looks like it isn't necessary,
             * so we just NO-OP it.
             */
            {&kextRadeonX6000, find_hwchannel_submitCommandBuffer,
             repl_hwchannel_submitCommandBuffer,
             arrsize(find_hwchannel_submitCommandBuffer), 2},
            /**
             * Mismatched VTable Call to isDeviceValid.
             */
            {&kextRadeonX6000, find_hwchannel_waitForHwStamp,
             repl_hwchannel_waitForHwStamp,
             arrsize(find_hwchannel_waitForHwStamp), 2},
            /**
             * Mismatched VTable Call to getScheduler.
             */
            {&kextRadeonX6000, find_hwchannel_reset, repl_hwchannel_reset,
             arrsize(find_hwchannel_reset), 2},
            /**
             * Mismatched VTable Calls to getScheduler.
             */
            {&kextRadeonX6000, find_hwchannel_timestampUpdated1,
             repl_hwchannel_timestampUpdated1,
             arrsize(find_hwchannel_timestampUpdated1), 2},
            {&kextRadeonX6000, find_hwchannel_timestampUpdated2,
             repl_hwchannel_timestampUpdated2,
             arrsize(find_hwchannel_timestampUpdated2), 2},
            /**
             * Mismatched VTable Call to isDeviceValid.
             */
            {&kextRadeonX6000, find_hwchannel_enableTimestampInterrupt,
             repl_hwchannel_enableTimestampInterrupt,
             arrsize(find_hwchannel_enableTimestampInterrupt), 2},
            /**
             * Mismatched VTable Call to getScheduler.
             */
            {&kextRadeonX6000, find_hwchannel_writeDiagnosisReport,
             repl_hwchannel_writeDiagnosisReport,
