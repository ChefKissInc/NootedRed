...
/**
 * Patch for Apple Graphics Device Policy.
...
/**
 * Patch for `AmdAtomFwServices::initializeAtomDataTable`.
...
/**
 * Patch for `AmdAtomFwServices::getFirmwareInfo`.
...
/**
 * Patch for `AMDRadeonX6000_AmdAgdcServices::getVendorInfo`.
...
/**
 * Patch for `AMDRadeonX5000_AMDHardware::startHWEngines`.
...
/**
 * Patch for `AMDRadeonX6000_AMDHWChannel::submitCommandBuffer`.
