...
/** `Vcn2EncCommand::addInputFormatPacket` */
...
/** `Vcn2EncCommand::addOutputFormatPacket` */
...
static const uint8_t kAddFormatPacketMask[] = {0xFF, 0xFF, 0xFF, 0xFF, 0xF8, 0xFF, 0xC0, 0xFF, 0xFF, 0x00, 0x00, 0xFF,
