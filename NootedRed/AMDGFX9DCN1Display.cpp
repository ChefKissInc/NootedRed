...
#include <Regs/DCN1.hpp>
#include <libkern/OSTypes.h>
#include <libkern/c++/OSMetaClass.h>

PWDefineRuntimeMC(AMDRadeonX5000_AMDGFX9DCN1Display, Constructor)

AMDRadeonX5000_AMDGFX9DCNDisplay::VFT AMDRadeonX5000_AMDGFX9DCN1Display::vft;

void AMDRadeonX5000_AMDGFX9DCN1Display::Constructor(AMDRadeonX5000_AMDGFX9DCN1Display* const self,
...
void AMDRadeonX5000_AMDGFX9DCN1Display::resolve(const char* const kext)
{
    ...
    DBGLOG("GFX9DCN1Display", "Module initialised");
}
